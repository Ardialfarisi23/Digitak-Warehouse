...
export function SupervisorDashboard() {
  ...
  return (
    <div className="flex w-full min-h-screen flex-col">
      ...
      <main className="p-8 pt-6 max-w-[1600px] w-full mx-auto space-y-6">
        {/* TITLE & FILTER BAR */}
        ...
        {/* GRID UTAMA (KIRI UTAMA & KANAN SIDEBAR) */}
        <div className="grid gap-6 xl:grid-cols-12">
          ...
          <div className="xl:col-span-8 space-y-6">
            ...
            {/* TREN TRANSAKSI 7 HARI (BAR CHART) */}
            ...
            {/* TWO COLUMNS BOTTOM (MENUNGGU APPROVAL & AKTIVITAS TERBARU) */}
          ...
          <div className="xl:col-span-4 space-y-6">
            ...
            <div className="rounded-2xl bg-white p-6 shadow-sm border border-stone-100 space-y-4">
              ...
              <div className="rounded-2xl border-2 border-dashed border-stone-200 bg-[#FAF8F3] p-5 space-y-4">
                ...
                <div className="flex flex-wrap gap-2 text-xs font-bold">
                  ...
                  <span className="rounded-md bg-orange-100 px-2.5 py-1 text-orange-700 flex items-center gap-1">
                    <Clock size={12} /> Belum Diupdate 3 hr
                  </span>
                </div>
              </div>
              ...
              {/* TIM SHIFT HARI INI */}
              <div className="pt-2">
                <p className="text-xs font-extrabold tracking-wider text-slate-400 uppercase mb-3">
                  TIM SHIFT HARI INI
                </p>
                <div className="flex items-center gap-3">
                  {[
                    { name: "Budi", count: 12, bg: "bg-amber-200" },
                    { name: "Siti", count: 8, bg: "bg-rose-200" },
                    { name: "Dedi", count: 15, bg: "bg-sky-200" },
                  ].map((staf) => (
                    <div
                      key={staf.name}
                    ...
                    >
                      <div className="relative">
                        <div
                          className={`h-11 w-11 rounded-full ${staf.bg} flex items-center justify-center font-bold text-slate-800 text-sm border-2 border-white shadow-sm`}
                        >
                          {staf.name.charAt(0)}
                        </div>
                        <span className="absolute -bottom-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full bg-slate-800 text-[9px] font-extrabold text-white">
                          {staf.count}
                        </span>
                      </div>
                  ...
                  <button className="flex h-11 w-11 items-center justify-center rounded-full border-2 border-dashed border-stone-300 text-slate-400 hover:bg-stone-100 transition">
                    <Plus size={18} />
                  </button>
                </div>
              </div>
